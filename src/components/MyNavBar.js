...
export default class MyNavBar extends Component {
    ...
    render() {
      const shoppingcart=(this.props.activeUser.accountType==="buyer")? <> <MyAccount></MyAccount><ShoppingCart></ShoppingCart></>:<><MyAccount></MyAccount><Nav.Link href="/#/sell">upload items</Nav.Link></>
